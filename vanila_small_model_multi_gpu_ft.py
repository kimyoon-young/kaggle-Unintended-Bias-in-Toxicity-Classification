...
output_model_file = "small_bert_pytorch_170mi_300maxlen_lr5e5-2e5"
...
model.load_state_dict(torch.load('small_bert_pytorch_170mi_300maxlen_lr5e5_epoch_1.bin'))

tq = tqdm(range(2, EPOCHS))
for epoch in tq:
